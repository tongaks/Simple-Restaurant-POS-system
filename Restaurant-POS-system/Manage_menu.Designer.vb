...
Partial Class Manage_menu
    ...
    Private Sub InitializeComponent()
        ...
        SettingsPicBox.Location = New Point(1761, 12)
        ...
        FoodPnl.Location = New Point(-3, 173)
        FoodPnl.Name = "FoodPnl"
        FoodPnl.Padding = New Padding(10)
        FoodPnl.Size = New Size(645, 430)
        FoodPnl.TabIndex = 6
        ' 
        ' Panel1
        ' 
        ...
        OrderPnl.Location = New Point(648, 70)
